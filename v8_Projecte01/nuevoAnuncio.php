...
/*	echo "$anu_nom<br/>";
	...
	$sql = ("SELECT * FROM `tbl_contacte` WHERE tbl_contacte.contact_email = 'carlesmartin@hotmail.com'");
	//echo "$sql";
	//echo "<br/>";
...
<div class="main-block">
    ...
    <div class="pages-indent">
		<form action="#" method="post" id="form-validate" onsubmit="return validate_form ( );">
